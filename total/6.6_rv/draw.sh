...
sshpass -p rv scp rv@10.30.6.1:/home/rv/fuzzer-repo/kconfigfuzz/rv-4p1q2c4g-66-1024.log kc
sshpass -p rv scp rv@10.30.6.1:/home/rv/fuzzer-repo/syzkaller/rv-4p1q2c4g-66-1024.log syzkaller

# 定义字符串数组（下标从 0 开始）
files=("kc" "syzkaller")
labels=("KConfigFuzz" "Syzkaller")
