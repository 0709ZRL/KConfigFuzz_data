#!/bin/bash
# 4procs 2qemu 1cpu 4g
sshpass -p zhaoruilin0709 scp zzzrrll@10.30.6.1:~/workdir_replace_SDM/log_6.6gcc_original healer-2

sshpass -p hfl scp hfl@10.30.6.1:/home/hfl/hfl-release/scripts/syzkaller-1022.log hfl
sshpass -p jiakai scp jiakai@10.30.6.1:/home/jiakai/0919/kconfigfuzz/fuzz-4p2q1c4g-1022.log kc
sshpass -p jiakai scp jiakai@10.30.6.1:/home/jiakai/0919/syzkaller/fuzz-4p2q1c4g-1022.log syzkaller
sshpass -p jiakai scp jiakai@10.30.6.1:/home/jiakai/0919/kconfigfuzz-ns/fuzz-4p2q1c4g-1022.log kc-d
sshpass -p jiakai scp jiakai@10.30.6.1:/home/jiakai/0919/kconfigfuzz-nd/fuzz-4p2q1c4g-1022.log kc-v

# 定义字符串数组（下标从 0 开始）
files=("kc" "syzkaller" "kc-d" "kc-v" "healer-2" "hfl")
