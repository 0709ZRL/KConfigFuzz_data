...
sshpass -p jiakai scp jiakai@10.30.6.1:/home/jiakai/vini/kconfigfuzz/66-6p1q8c4g-1103.log kc-nod-8c
sshpass -p jiakai scp jiakai@10.30.6.1:/home/jiakai/vini/kconfigfuzz/66-6p1q4c4g-1103.log kc-nod-4c
...
# 定义字符串数组（下标从 0 开始）
files=("kc" "kc-newD-noqueue-2" "kc-nod-4c" "kc-nod-8c")
