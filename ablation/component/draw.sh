...
sshpass -p jiakai scp jiakai@10.30.6.1:/home/jiakai/0919/kconfigfuzz-nd/fuzz-1016.log fuzz-6.6-kconfigfuzz-v.log
sshpass -p jiakai scp jiakai@10.30.6.1:/home/jiakai/0919/kconfigfuzz-ns/fuzz-1016.log fuzz-6.6-kconfigfuzz-d.log
...
# 定义字符串数组（下标从 0 开始）
files=("log_6.6gcc_original" "fuzz-6.6-syzkaller.log" "fuzz-6.6-kconfigfuzz.log" "fuzz-6.6-kconfigfuzz-d.log" "fuzz-6.6-kconfigfuzz-v.log")
labels=("HEALER" "Syzkaller" "KConfigFuzz" "KC-D" "KC-V")
